...
Mounted volume names may only contain letters and underscore (no dashes)
and are limited to 32 characters. Names may be autogenerated from the
bucket name, but to avoid any surprises with long names, provide your own.
...
Required:
    ...
    -v --volume     <text>      name of the bucket, repeat as necessary
                                    do not include 
